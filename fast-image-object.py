...
TEST_IMAGE_PATHS = [ os.path.join(PATH_TO_TEST_IMAGES_DIR, 'image{}.jpg'.format(i)) for i in range(60, 79) ]
...
#       plt.imshow(image_np)
      ...
      aov = 55
      ch = 180
      imageHeight = int(np.size(image, 0))
      imageWidth = int(np.size(image, 1))
      ...
      bigBody1 = w * 3
      bigBody2 = x -(w * 2)
      roi = image_np[y:y+halfBody, bigBody2:bigBody2+bigBody1]
...
with tf.Session() as sess2:
    ...
    os.chdir("/root/models/research/object_detection/save_image/")
    #count1=1
    ...
    for file in glob.glob("*.jpg"):
        ...
        predictions = sess2.run(softmax_tensor, {'DecodeJpeg/contents:0': image_data})
